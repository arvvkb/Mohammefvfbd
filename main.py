...
import os
token = '7046333206:AAGzJExhM5f_f-gTIetYVcXAyFvzEHOvWzc'
bot=telebot.TeleBot(token,parse_mode="HTML")
subscriber ='6379161238'
@bot.message_handler(commands=["start"])
def start(message):
	if not str(message.chat.id) == '6379161238':
		bot.reply_to(message, "You cannot use the bot to contact developers to purchase a bot subscription @O_7_I")
		return
